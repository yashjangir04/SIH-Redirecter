...
const Cards = ({modelName , desc , link , imgNo}) => {
  ...
  return (
    <div
      className="w-[300px] h-[330px] bg-white rounded-3xl transition-all duration-500 relative flex flex-col items-center px-[20px] group hover:translate-y-[-4px] cursor-pointer"
      onClick={handleClick}
    >
      ...
      <div className="about flex flex-col items-center transition-all duration-800 w-full mt-[2px]">
        ...
        <button className="mt-[25px] bg-green-900 px-4 py-2 rounded-md group cursor-pointer transition-all duration-300 hover:bg-green-500 hover:scale-102 text-white">
          Try Now
        </button>
      </div>
    </div>
